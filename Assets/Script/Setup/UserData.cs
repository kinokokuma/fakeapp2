...
public class UserData : MonoBehaviour
{
    ...
    private string story1Des = "ในเกมนี้ผู้เล่นจะได้รับบทเป็นตัวละครชื่อนภัส เอื้อสุทรกุล อาศัยอยู่ที่จังหวัดสระบุรี มีเพื่อนสนิทสองคนคือ แม้น และพงศ์ และเป็นคุณ{type}ของผิงผิงผู้เป็นหลานสาวของคุณ ซึ่งกำลังจะมาเยี่ยมคุณในวันนี้พร้อมกับพ่อและแม่ของเธอ\r\nการทำธุรกรรมทางการเงินของผู้เล่นในเนื้อเรื่องจะดำเนินการผ่านธนาคารกุ้งไทย\r\n";
    private string story2Des = "ในเกมนี้ผู้เล่นจะได้รับบทเป็นตัวละครชื่อจินต์ สรรพกุลธร อาศัยอยู่ที่ตำบลห้วยขวาง อำเภอกำแพงแสน\r\n จังหวัดนครปฐม และคุณเป็นเจ้าของที่ดินขนาด 5 ไร่ 2 งาน เลขที่โฉนด 456125 ตั้งอยู่ที่ตำบลห้วยขวาง อำเภอกำแพงแสน จังหวัดนครปฐม\r\nผู้เล่นมีเพื่อนสนิทสองคนคือ หาญ และอุ่ม และเป็นคุณ{type}ของภูมิผู้เป็นหลานชายที่อาศัยอยู่กรุงเทพ\r\nการทำธุรกรรมทางการเงินของผู้เล่นในเนื้อเรื่องจะดำเนินการผ่านธนาคารกุ้งไทย\r\n";
